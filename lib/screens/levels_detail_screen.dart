...
class LevelsDetailScreen extends StatelessWidget {
  final int xpAtual;
  final int levelAtual;

  const LevelsDetailScreen({
    super.key,
    required this.xpAtual,
    required this.levelAtual,
  });
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          final String maxText = nivel['max'] == null ? "∞" : "${nivel['max']}";

          bool ehAtual = lvItem == levelAtual;
          bool bloqueado = lvItem > levelAtual;
